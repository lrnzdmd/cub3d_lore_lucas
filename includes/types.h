...
/*   Updated: 2025/11/29 05:11:11 by lde-medi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
typedef enum e_enemy_state			t_enm_st;
...
typedef void						(*t_en_state_func)(t_cub *data,
		t_ent *enemy);
typedef void						(*t_pl_state_func)(t_cub *data,
		t_plyr *player);
