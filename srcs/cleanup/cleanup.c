...
/*   Updated: 2025/11/28 07:16:01 by lde-medi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	free_gfx_data(t_cub	*data)
{
	...
	safe_mlx_free_img(mlx, gfx->txt.sprts.enemy.walk_a.frame[0].img_p);
	safe_mlx_free_img(mlx, gfx->txt.sprts.enemy.walk_a.frame[1].img_p);
	...
	ft_multifree(3, &gfx->txt.sprts.enemy.walk_a.frame, &data->gman.enemies, &data->gfx.zbuffer);
}
